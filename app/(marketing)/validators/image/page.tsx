...
import { Image as ImageIcon, FileText, Film, ExternalLink, Lightbulb } from 'lucide-react'
    ...
    <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
      <div className="mb-6 flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Analyze images with Gemini or Claude Vision models.</p>
        </div>
        ...
        <div className="flex items-start gap-2">
          ...
          <div className="text-sm text-muted-foreground">
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>Prefer clear, well-lit images for better results.</li>
              <li>Smaller files upload faster; keep under a few MB.</li>
              <li>Cross-check providers for nuanced cases.</li>
            </ul>
          </div>
        </div>
      </div>
